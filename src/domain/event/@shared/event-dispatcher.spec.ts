...
import ConsoleLog1HandlerCreatedHandler from "../Customer/handler/console-log-1-handler-created.handler";
import ConsoleLog2HandlerCreatedHandler from "../Customer/handler/console-log-2-handler-created.handler";
import ConsoleLogTrocaEnderecoHandler from "../Customer/handler/console-log-troca-endereco.handler";
import CheckStokWhenProductIsCreated from "../Product/handler/check-stoque-when-product-is-created.handler";
